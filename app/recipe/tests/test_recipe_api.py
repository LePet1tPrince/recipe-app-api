...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            ...
            description='https://example.com/recipe.pdf'
        )
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='user3@example.com', password='newpass')
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('10.00'),
            'ingredients': [{'name': 'Cauliflower'}, {'name': 'Taco Shell'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        recipe2 = create_recipe(user=self.user, title='Aubergine with Tihini')
